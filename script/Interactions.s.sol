...
contract FundSubscription is Script {
    ...
    function fundSubscription(address vrfCoordinator, address link, uint64 subId, uint256 deployerKey) public {
...
contract AddConsumer is Script {
    ...
    function addConsumer(address raffle, address vrfCoordinator, uint64 subId, uint256 deplyerKey) public {
        console.log("Adding consumer contract: ", raffle);
        console.log("Using vrfCoordinator: ", vrfCoordinator);
        console.log("On ChainId: ", block.chainid);
        vm.startBroadcast(deplyerKey);
